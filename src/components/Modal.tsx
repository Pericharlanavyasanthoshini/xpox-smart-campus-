...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`w-full ${maxWidthClasses} bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden transform transition-all animate-in zoom-in-95 duration-200`}
